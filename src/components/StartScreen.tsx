  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-love-primary/90 via-love-accent/80 to-love-secondary/90 flex flex-col justify-center items-center z-50 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full opacity-20 pointer-events-none">
        ...
        <div className="absolute bottom-1/3 right-1/3 w-48 h-48 bg-white rounded-full mix-blend-soft-light animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 right-4 w-20 h-20 md:w-32 md:h-32 bg-white rounded-full mix-blend-soft-light animate-float" style={{ animationDelay: '4s' }}></div>
      </div>

      <div className="relative text-center text-white px-4 backdrop-blur-sm bg-white/10 rounded-3xl py-12 px-8 shadow-2xl border border-white/20 max-w-md mx-4">
        ...
        >
          <span className="relative z-10">Vem comigo? 💖</span>
      ...
      <div className="absolute bottom-8 text-white font-body text-sm backdrop-blur-sm bg-black/20 rounded-full py-2 px-4">
        <p className="opacity-90">Tudo começou em <span className="font-semibold">04/07/2023</span></p>
      </div>
    </div>
  );
}